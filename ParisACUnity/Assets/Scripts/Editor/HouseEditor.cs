...
public class HouseEditor : ShapeEditor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        DrawSerializedObjectField("House Scriptable Object Template", nameof(_house.Settings),
        ...
        DrawSettingsFields("House Properties:", nameof(_house.SettingsDataCopy),
    ...
    private void DrawSerializedObjectField(string headerText, string scriptableObjectName, string defaultObjectPath)
    {
        ...
        EditorGUILayout.BeginHorizontal();
        {
            ...
            {
                serializedObject.ApplyModifiedProperties();
                _house.UpdateSettings(scriptableObjectName);
            }
