...
namespace Demo
{
    ...
    public abstract class Shape : MonoBehaviour
    {
        ...
        /// </summary>
        protected T CreateSymbol<T>(string name, Vector3 localPosition = new Vector3(), Quaternion localRotation = new Quaternion(), Vector3 localScale = new Vector3(), Transform parent = null) where T : Shape
        {
            if (parent == null)
            {
        ...
        /// </summary>
        protected GameObject SpawnPrefab(GameObject prefab, Vector3 localPosition = new Vector3(), Quaternion localRotation = new Quaternion(), Vector3 localScale = new Vector3(), Transform parent = null)
        {
            if (parent == null)
            {
                parent = transform; // default: add as child game object
